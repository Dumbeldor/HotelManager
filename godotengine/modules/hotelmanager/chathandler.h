...
struct ChatCommand
{
	const char* name;
	bool console;
	bool (ChatHandler::*Handler)(const std::string &args, GameSession *game_session, std::string &msg);
...
public:
	...
	//Money
	bool handle_command_money_add(const std::string &args, GameSession *game_session, std::string &msg);
	bool handle_command_money_remove(const std::string &args, GameSession *game_session, std::string &msg);

	//Time
	bool handle_command_time_speed(const std::string &args, GameSession *game_session, std::string &msg);

	//list
	bool handle_command_list(const std::string &args, GameSession *game_session, std::string &msg);
	...
	bool handle_command_add_notif(const std::string &args, GameSession *game_session, std::string &msg);
